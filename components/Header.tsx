...
import {ChevronDownIcon, BellIcon, ShoppingCartIcon} from '@heroicons/react/outline';
...
function Header({}: Props) {
  ...
  return (
    <div className='max-w-6xl mx-auto p-2'>
        ...
        />
        {address ? ('') : (
            <p className='font-bold text-red-500 text-center animate-bounce'>Wallet is not connected!</p>
        ) }
        ...
        <hr />
        <section className='flex py-3 text-xs space-x-6 md:text-sm whitespace-nowrap justify-center px-6'>
